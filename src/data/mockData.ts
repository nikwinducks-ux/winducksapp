...
// ===== SERVICE PROVIDERS (10, Calgary-area) =====
export const serviceProviders: ServiceProvider[] = [
  {
    id: "sp-001", name: "Mike Thompson", email: "mike@example.com", phone: "(403) 555-0101",
    avatar: "MT", status: "Active",
    baseAddress: { street: "50 Kensington Rd NW", city: "Calgary", province: "AB", postalCode: "T2N 3C8", country: "Canada", lat: 51.0550, lng: -114.0900 },
    rating: 4.8, reliabilityScore: 92, completionRate: 96, onTimeRate: 94,
  ...
  },
  {
    ...
    avatar: "SC", status: "Active",
    baseAddress: { street: "215 12th Ave SW", city: "Calgary", province: "AB", postalCode: "T2R 0G8", country: "Canada", lat: 51.0410, lng: -114.0780 },
    rating: 4.9, reliabilityScore: 97, completionRate: 99, onTimeRate: 97,
  ...
  },
  {
    ...
    avatar: "JW", status: "Active",
    baseAddress: { street: "80 Main St", city: "Airdrie", province: "AB", postalCode: "T4B 2E3", country: "Canada", lat: 51.2900, lng: -114.0200 },
    rating: 4.5, reliabilityScore: 85, completionRate: 90, onTimeRate: 88,
    ...
    notes: "Based in Airdrie, prefers north Calgary jobs.",
  },
  {
    id: "sp-004", name: "Emily Rodriguez", email: "emily@example.com", phone: "(403) 555-0104",
    avatar: "ER", status: "Active",
    baseAddress: { street: "340 Centre Ave", city: "Cochrane", province: "AB", postalCode: "T4C 1K3", country: "Canada", lat: 51.1870, lng: -114.4700 },
    rating: 4.7, reliabilityScore: 90, completionRate: 94, onTimeRate: 92,
    ...
    notes: "Based in Cochrane.",
  },
  {
    id: "sp-005", name: "David Park", email: "david@example.com", phone: "(403) 555-0105",
    avatar: "DP", status: "Active",
    baseAddress: { street: "55 2nd St W", city: "Okotoks", province: "AB", postalCode: "T1S 1A4", country: "Canada", lat: 50.7250, lng: -113.9800 },
    rating: 4.6, reliabilityScore: 88, completionRate: 92, onTimeRate: 90,
    ...
    notes: "Based in Okotoks — far from north Calgary.",
  },
  {
    id: "sp-006", name: "Lisa Martinez", email: "lisa@example.com", phone: "(403) 555-0106",
    avatar: "LM", status: "Suspended",
    baseAddress: { street: "18 Elgin Meadows Way SE", city: "Calgary", province: "AB", postalCode: "T2Z 4E3", country: "Canada", lat: 50.9350, lng: -114.0500 },
    rating: 4.4, reliabilityScore: 82, completionRate: 88, onTimeRate: 85,
    ...
    notes: "Insurance expired — suspended pending renewal.",
  },
  {
    id: "sp-007", name: "Robert Kim", email: "robert@example.com", phone: "(403) 555-0107",
    avatar: "RK", status: "Active",
    baseAddress: { street: "410 Country Hills Blvd NE", city: "Calgary", province: "AB", postalCode: "T3K 4Y7", country: "Canada", lat: 51.1520, lng: -114.0600 },
    rating: 4.8, reliabilityScore: 94, completionRate: 97, onTimeRate: 95,
  ...
  },
  {
    ...
    baseAddress: { street: "92 Rainbow Falls Way", city: "Chestermere", province: "AB", postalCode: "T1X 0H3", country: "Canada", lat: 51.0380, lng: -113.8200 },
    rating: 4.3, reliabilityScore: 80, completionRate: 86, onTimeRate: 83,
    ...
    notes: "Based in Chestermere.",
  },
  {
    id: "sp-009", name: "Carlos Ruiz", email: "carlos@example.com", phone: "(403) 555-0109",
    avatar: "CR", status: "Active",
    baseAddress: { street: "720 14th St NW", city: "Calgary", province: "AB", postalCode: "T2N 2A4", country: "Canada", lat: 51.0610, lng: -114.0950 },
    rating: 4.7, reliabilityScore: 91, completionRate: 95, onTimeRate: 93,
  ...
  },
  {
    ...
    avatar: "NP", status: "Active",
    baseAddress: { street: "505 Canyon Meadows Dr SE", city: "Calgary", province: "AB", postalCode: "T2J 6G2", country: "Canada", lat: 50.9620, lng: -114.0650 },
    rating: 4.6, reliabilityScore: 89, completionRate: 93, onTimeRate: 91,
...
// Helper to build flat address string
...
export const jobs: Job[] = [
  {
    id: "JOB-1001", customerId: "cust-001", customerName: "John Baker",
    address: "123 Main St NW, Calgary", jobAddress: customers[0].serviceAddress,
    serviceCategory: "Window Cleaning", estimatedDuration: "2 hours",
    scheduledDate: "2026-02-23", scheduledTime: "09:00 AM", payout: 180,
    status: "assigned", assignedSpId: "sp-001",
    scores: { availabilityFit: 92, proximity: 88, competency: 85, reliability: 92, rating: 96, fairnessAdjustment: 5, finalScore: 91 },
  },
  {
    id: "JOB-1002", customerId: "cust-002", customerName: "Maria Santos",
    address: "456 Bow Trail SW, Calgary", jobAddress: customers[1].serviceAddress,
  ...
  {
    id: "JOB-1003", customerId: "cust-003", customerName: "Tom Henderson",
    address: "789 Centre St N, Calgary", jobAddress: customers[2].serviceAddress,
  ...
  {
    id: "JOB-1004", customerId: "cust-004", customerName: "Rachel Green",
    address: "321 17th Ave SW, Calgary", jobAddress: customers[3].serviceAddress,
    serviceCategory: "Window Cleaning", estimatedDuration: "1.5 hours",
    scheduledDate: "2026-02-24", scheduledTime: "02:00 PM", payout: 140,
    status: "assigned", assignedSpId: "sp-002",
    scores: { availabilityFit: 85, proximity: 65, competency: 95, reliability: 97, rating: 98, fairnessAdjustment: -5, finalScore: 89 },
  },
  {
    id: "JOB-1005", customerId: "cust-005", customerName: "Alex Turner",
    address: "555 Macleod Trail SE, Calgary", jobAddress: customers[4].serviceAddress,
  ...
  {
    id: "JOB-1006", customerId: "cust-006", customerName: "Diana Prince",
    address: "100 Crowfoot Way NW, Calgary", jobAddress: customers[5].serviceAddress,
    serviceCategory: "Window Cleaning", estimatedDuration: "2 hours",
  ...
  {
    id: "JOB-1007", customerId: "cust-007", customerName: "Bruce Wayne",
    address: "900 Deerfoot Trail NE, Calgary", jobAddress: customers[6].serviceAddress,
  ...
  {
    id: "JOB-1008", customerId: "cust-008", customerName: "Clark Kent",
    address: "200 University Dr NW, Calgary", jobAddress: customers[7].serviceAddress,
    serviceCategory: "Window Cleaning", estimatedDuration: "1 hour",
    scheduledDate: "2026-02-26", scheduledTime: "03:00 PM", payout: 95,
    status: "completed", assignedSpId: "sp-004",
    scores: { availabilityFit: 96, proximity: 96, competency: 82, reliability: 90, rating: 94, fairnessAdjustment: 2, finalScore: 93 },
  },
  {
    id: "JOB-1009", customerId: "cust-009", customerName: "Peter Parker",
    address: "750 9th Ave SE, Calgary", jobAddress: customers[8].serviceAddress,
  ...
  {
    id: "JOB-1010", customerId: "cust-010", customerName: "Tony Stark",
    address: "500 4th St SW, Calgary", jobAddress: customers[9].serviceAddress,
  ...
  {
    id: "JOB-1011", customerId: "cust-011", customerName: "Natasha Romanov",
    address: "310 Heritage Dr SE, Calgary", jobAddress: customers[10].serviceAddress,
    serviceCategory: "Window Cleaning", estimatedDuration: "2 hours",
    scheduledDate: "2026-02-28", scheduledTime: "09:00 AM", payout: 165,
    status: "pending",
  },
  {
    id: "JOB-1012", customerId: "cust-012", customerName: "Steve Rogers",
    address: "888 Country Hills Blvd NE, Calgary", jobAddress: customers[11].serviceAddress,
    serviceCategory: "Gutter Cleaning", estimatedDuration: "3.5 hours",
    scheduledDate: "2026-02-28", scheduledTime: "11:30 AM", payout: 310,
    status: "assigned", assignedSpId: "sp-007",
    scores: { availabilityFit: 75, proximity: 50, competency: 95, reliability: 94, rating: 96, fairnessAdjustment: 2, finalScore: 83 },
  },
  {
    id: "JOB-1013", customerId: "cust-013", customerName: "Wanda Maximoff",
    address: "425 Memorial Dr NE, Calgary", jobAddress: customers[12].serviceAddress,
    serviceCategory: "Window Cleaning", estimatedDuration: "1.5 hours",
    scheduledDate: "2026-03-01", scheduledTime: "10:00 AM", payout: 135,
    status: "declined",
  },
  {
    id: "JOB-1014", customerId: "cust-006", customerName: "Diana Prince",
    address: "100 Crowfoot Way NW, Calgary", jobAddress: customers[5].serviceAddress,
    serviceCategory: "Pressure Washing", estimatedDuration: "4 hours",
  ...
  {
    id: "JOB-1015", customerId: "cust-014", customerName: "Sam Wilson",
    address: "150 Shawnessy Blvd SW, Calgary", jobAddress: customers[13].serviceAddress,
    serviceCategory: "Gutter Cleaning", estimatedDuration: "2 hours",
    scheduledDate: "2026-03-02", scheduledTime: "09:00 AM", payout: 185,
    status: "in-progress", assignedSpId: "sp-009",
    scores: { availabilityFit: 80, proximity: 48, competency: 88, reliability: 91, rating: 94, fairnessAdjustment: 5, finalScore: 80 },
  },
  {
    id: "JOB-1016", customerId: "cust-015", customerName: "Pepper Potts",
    address: "290 52nd St SE, Calgary", jobAddress: customers[14].serviceAddress,
    serviceCategory: "Window Cleaning", estimatedDuration: "2.5 hours",
    scheduledDate: "2026-03-02", scheduledTime: "01:00 PM", payout: 215,
    status: "pending",
  },
  {
    id: "JOB-1017", customerId: "cust-016", customerName: "Happy Hogan",
    address: "400 Beddington Blvd NE, Calgary", jobAddress: customers[15].serviceAddress,
    serviceCategory: "Pressure Washing", estimatedDuration: "3 hours",
    scheduledDate: "2026-03-03", scheduledTime: "10:00 AM", payout: 275,
    status: "pending",
  },
  {
    id: "JOB-1018", customerId: "cust-017", customerName: "Nick Fury",
    address: "50 Signal Hill Centre SW, Calgary", jobAddress: customers[16].serviceAddress,
    serviceCategory: "Gutter Cleaning", estimatedDuration: "2 hours",
    scheduledDate: "2026-03-03", scheduledTime: "02:30 PM", payout: 200,
    status: "pending",
  },
  {
    id: "JOB-1019", customerId: "cust-018", customerName: "Phil Coulson",
    address: "725 Harvest Hills Dr NE, Calgary", jobAddress: customers[17].serviceAddress,
    serviceCategory: "Window Cleaning", estimatedDuration: "1 hour",
    scheduledDate: "2026-03-04", scheduledTime: "11:00 AM", payout: 90,
    status: "completed", assignedSpId: "sp-005",
    scores: { availabilityFit: 65, proximity: 40, competency: 85, reliability: 88, rating: 92, fairnessAdjustment: 8, finalScore: 75 },
  },
  {
    id: "JOB-1020", customerId: "cust-019", customerName: "May Parker",
    address: "180 Tuscany Blvd NW, Calgary", jobAddress: customers[18].serviceAddress,
    serviceCategory: "Pressure Washing", estimatedDuration: "3.5 hours",
    scheduledDate: "2026-03-04", scheduledTime: "09:00 AM", payout: 320,
    status: "pending",
  },
  {
    id: "JOB-1021", customerId: "cust-020", customerName: "Janet Van Dyne",
    address: "45 Main St, Cochrane", jobAddress: customers[19].serviceAddress,
    serviceCategory: "Window Cleaning", estimatedDuration: "3 hours",
    scheduledDate: "2026-03-05", scheduledTime: "10:00 AM", payout: 280,
    status: "pending",
  },
  {
    id: "JOB-1022", customerId: "cust-021", customerName: "Hank Pym",
    address: "120 East Lake Blvd, Airdrie", jobAddress: customers[20].serviceAddress,
    serviceCategory: "Gutter Cleaning", estimatedDuration: "2 hours",
    scheduledDate: "2026-03-06", scheduledTime: "09:00 AM", payout: 195,
    status: "pending",
  },
  {
    id: "JOB-1023", customerId: "cust-022", customerName: "Scott Lang",
    address: "88 Milligan Dr, Okotoks", jobAddress: customers[21].serviceAddress,
    serviceCategory: "Pressure Washing", estimatedDuration: "4 hours",
    scheduledDate: "2026-03-07", scheduledTime: "08:00 AM", payout: 350,
    status: "pending",
  },
  {
    id: "JOB-1024", customerId: "cust-023", customerName: "Hope Pym",
    address: "200 Chestermere Blvd, Chestermere", jobAddress: customers[22].serviceAddress,
    serviceCategory: "Window Cleaning", estimatedDuration: "2.5 hours",
    scheduledDate: "2026-03-08", scheduledTime: "11:00 AM", payout: 230,
    status: "pending",
  },
];
