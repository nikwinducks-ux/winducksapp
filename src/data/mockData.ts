...
export const jobs: Job[] = [
  { id: "JOB-1001", customerId: "cust-001", customerName: "John Baker", address: "123 Main St NW, Calgary", jobAddress: customers[0].serviceAddress, serviceCategory: "Window Cleaning", estimatedDuration: "2 hours", scheduledDate: "2026-02-23", scheduledTime: "09:00 AM", payout: 180, status: "assigned", assignedSpId: "sp-001", scores: { availabilityFit: 92, proximity: 88, competency: 85, reliability: 92, rating: 96, fairnessAdjustment: 5, finalScore: 91 }, notes: "Please be careful with the plants.", urgency: "Scheduled" },
  { id: "JOB-1002", customerId: "cust-002", customerName: "Maria Santos", address: "456 Bow Trail SW, Calgary", jobAddress: customers[1].serviceAddress, serviceCategory: "Gutter Cleaning", estimatedDuration: "3 hours", scheduledDate: "2026-02-23", scheduledTime: "01:00 PM", payout: 260, status: "pending", scores: { availabilityFit: 78, proximity: 72, competency: 90, reliability: 88, rating: 94, fairnessAdjustment: 8, finalScore: 85 }, notes: "Watch out for the loose ladder.", urgency: "ASAP" },
  { id: "JOB-1003", customerId: "cust-003", customerName: "Tom Henderson", address: "789 Centre St N, Calgary", jobAddress: customers[2].serviceAddress, serviceCategory: "Pressure Washing", estimatedDuration: "4 hours", scheduledDate: "2026-02-24", scheduledTime: "10:00 AM", payout: 340, status: "pending", scores: { availabilityFit: 95, proximity: 95, competency: 80, reliability: 90, rating: 92, fairnessAdjustment: 3, finalScore: 92 }, notes: "", urgency: "AnytimeSoon" },
  { id: "JOB-1004", customerId: "cust-004", customerName: "Rachel Green", address: "321 17th Ave SW, Calgary", jobAddress: customers[3].serviceAddress, serviceCategory: "Window Cleaning", estimatedDuration: "1.5 hours", scheduledDate: "2026-02-24", scheduledTime: "02:00 PM", payout: 140, status: "assigned", assignedSpId: "sp-002", scores: { availabilityFit: 85, proximity: 65, competency: 95, reliability: 97, rating: 98, fairnessAdjustment: -5, finalScore: 89 }, notes: "Customer prefers eco-friendly products.", urgency: "Scheduled" },
  { id: "JOB-1005", customerId: "cust-005", customerName: "Alex Turner", address: "555 Macleod Trail SE, Calgary", jobAddress: customers[4].serviceAddress, serviceCategory: "Gutter Cleaning", estimatedDuration: "2.5 hours", scheduledDate: "2026-02-25", scheduledTime: "09:30 AM", payout: 220, status: "pending", scores: { availabilityFit: 88, proximity: 80, competency: 88, reliability: 85, rating: 90, fairnessAdjustment: 10, finalScore: 88 }, notes: "", urgency: "Scheduled" },
  { id: "JOB-1006", customerId: "cust-006", customerName: "Diana Prince", address: "100 Crowfoot Way NW, Calgary", jobAddress: customers[5].serviceAddress, serviceCategory: "Window Cleaning", estimatedDuration: "2 hours", scheduledDate: "2026-02-25", scheduledTime: "11:00 AM", payout: 175, status: "assigned", assignedSpId: "sp-001", scores: { availabilityFit: 90, proximity: 90, competency: 85, reliability: 92, rating: 96, fairnessAdjustment: 4, finalScore: 90 }, notes: "Customer has a dog, be cautious.", urgency: "Scheduled" },
  { id: "JOB-1007", customerId: "cust-007", customerName: "Bruce Wayne", address: "900 Deerfoot Trail NE, Calgary", jobAddress: customers[6].serviceAddress, serviceCategory: "Pressure Washing", estimatedDuration: "5 hours", scheduledDate: "2026-02-26", scheduledTime: "08:00 AM", payout: 420, status: "pending", scores: { availabilityFit: 70, proximity: 55, competency: 92, reliability: 94, rating: 96, fairnessAdjustment: 6, finalScore: 82 }, notes: "Large property, allow extra time.", urgency: "AnytimeSoon" },
  { id: "JOB-1008", customerId: "cust-008", customerName: "Clark Kent", address: "200 University Dr NW, Calgary", jobAddress: customers[7].serviceAddress, serviceCategory: "Window Cleaning", estimatedDuration: "1 hour", scheduledDate: "2026-02-26", scheduledTime: "03:00 PM", payout: 95, status: "completed", assignedSpId: "sp-004", scores: { availabilityFit: 96, proximity: 96, competency: 82, reliability: 90, rating: 94, fairnessAdjustment: 2, finalScore: 93 }, notes: "", urgency: "Scheduled" },
  { id: "JOB-1009", customerId: "cust-009", customerName: "Peter Parker", address: "750 9th Ave SE, Calgary", jobAddress: customers[8].serviceAddress, serviceCategory: "Gutter Cleaning", estimatedDuration: "2 hours", scheduledDate: "2026-02-27", scheduledTime: "10:00 AM", payout: 190, status: "expired", scores: { availabilityFit: 60, proximity: 75, competency: 85, reliability: 80, rating: 88, fairnessAdjustment: 12, finalScore: 78 }, notes: "Customer requested reschedule.", urgency: "Scheduled" },
  { id: "JOB-1010", customerId: "cust-010", customerName: "Tony Stark", address: "500 4th St SW, Calgary", jobAddress: customers[9].serviceAddress, serviceCategory: "Pressure Washing", estimatedDuration: "3 hours", scheduledDate: "2026-02-27", scheduledTime: "01:00 PM", payout: 290, status: "pending", scores: { availabilityFit: 82, proximity: 85, competency: 78, reliability: 88, rating: 92, fairnessAdjustment: 7, finalScore: 86 }, notes: "Use side entrance.", urgency: "ASAP" },
];
